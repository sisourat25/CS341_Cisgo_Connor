document.addEventListener('DOMContentLoaded', function () {
    ...
    var table = new Tabulator("#pending-table", {
    ...
    document.getElementById("deletePendingButton").addEventListener("click", function() {
        // Get the selected rows
        var selectedRows = table.getSelectedRows();
    ...
    $.get('/adminTablePendingRoute', function(data) {
